# MySQL template
This is a template to run MySQL on [mogenius](https://mogenius.com). We use it to deploy a MySQL database from our service library. If you have your own MySQL database that you want to run on mogenius feel free to add this Dockerfile to your project.
